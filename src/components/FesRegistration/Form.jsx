  ...
  return (
    <>
      {loading ? (
        ...
        <div className="bg-yellow-400 w-screen overflow-hidden">
          <BentoBox regdata={regdata} />

          <div style={{ display: regdata.count == 2 ? "none" : "block" }}>
            <form onSubmit={handleSubmit}>
              <div className="bg-inherit bg-contain bg-[url('/Public/Images/Home/wl1.jpg')] py-8">
                <h1 className="font-megatron text-white text-4xl text-center mb-0 sm:text-6xl md:mb-3">
                  Registration
                </h1>
                ...
                <div className="grid items-center md:grid-cols-2 lg:px-16">
                  <div className="mt-8 bg-opacity-20 rounded-lg py-8 flex px-8 justify-evenly flex-col shadow-xl backdrop-blur-3xl border-[0.8]  hover:backdrop-blur-md transition-all duration-500 cursor-pointer">
                    <div className="flex-col justify-between text-black-900 items-center">
                      ...
                      <h1 className="text-xl font-semibold font-gilroy">1/8</h1>
                    </div>
                    <div>
                    ...
                    {formFields.event1.participants.map(
                      (participant, index) => (
                        <div key={index}>
                          <input
                            type="text"
                  ...
                  <div className="mt-8 bg-opacity-20 rounded-lg py-8 flex px-8 justify-evenly flex-col shadow-xl backdrop-blur-3xl border-[0.8]   hover:backdrop-blur-md transition-all duration-500 ">
                    <div className="flex-col justify-between text-black-900 items-center">
                      ...
                      <h1 className="text-xl font-semibold font-gilroy">3/8</h1>
                    </div>
                    <div>
                      <h3 className="mt-2 font-gilroy-light text-white">
                    ...
                    {formFields.event3.participants.map(
                      (participant, index) => (
                        <div key={index}>
                          <input
                            type="text"
                  ...
                  <div className="mt-8 bg-opacity-20 rounded-lg py-8 flex px-8 justify-evenly flex-col shadow-xl backdrop-blur-3xl border-[0.8]   hover:backdrop-blur-md transition-all duration-500 ">
                    <div className="flex-col justify-between gap-12 text-black-900 items-center">
                      ...
                      <h1 className="text-xl font-semibold font-gilroy">6/8</h1>
                    </div>
                    <div>
                      <h3 className="mt-2 font-gilroy-light text-white">
                    ...
                    {formFields.event6.participants.map(
                      (participant, index) => (
                        <div key={index}>
                          <input
                            type="text"
                  ...
                  <div className="mt-8 bg-opacity-20 rounded-lg py-8 flex px-8 justify-evenly flex-col shadow-xl backdrop-blur-3xl border-[0.8]   hover:backdrop-blur-md transition-all duration-500 ">
                    <div className="flex-col justify-between text-black-900 items-center">
                      ...
                      <h1 className="text-xl font-semibold font-gilroy">7/8</h1>
                    </div>
                    <div>
                      <h3 className="mt-2 font-gilroy-light text-white">
                    ...
                    {formFields.event7.participants.map(
                      (participant, index) => (
                        <div key={index}>
                          <input
                            type="text"
                  ...
                  <div className="mt-8 bg-opacity-20 rounded-lg py-8 flex px-8 justify-evenly flex-col shadow-xl backdrop-blur-3xl border-[0.8]  hover:backdrop-blur-md transition-all duration-500 ">
                    <div className="flex-col justify-between  text-black-900 items-center">
                      ...
                      <h1 className="text-xl font-semibold font-gilroy">8/8</h1>
                    </div>
                    <div>
                      <h3 className="mt-2 font-gilroy-light text-white">
                        Dance (3-5 members)
                    ...
                    {formFields.event8.participants.map(
                      (participant, index) => (
                        <div key={index}>
                          <input
                            type="text"
