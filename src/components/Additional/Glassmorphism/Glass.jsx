    ...
    >
      <div className="bg-image dark-overlay bg-center bg-cover bg-[url('/Public/Images/Home/wl3.jpg')] flex items-center justify-center w-screen px-8 gap-8 py-7 h-full">
        <motion.div
          ...
          className="bg-opacity-0 shadow-xl backdrop-blur-3xl border-[0.8] border-opacity-20 rounded-lg w-[500px] p-6  flex items-center justify-evenly flex-col cursor-pointer sm:h-96 hover:backdrop-blur-md transition-all duration-500 xl:hover:w-2/5"
        >
          <div>
